      ...
      <div
        ...
        <div className="relative z-10">
          ...
          <motion.div
            ...
            SkillShiksha is an innovative learning platform that offers a seamless and engaging experience for learners. Users can explore and purchase a variety of courses across different subjects, ensuring a personalized learning journey. With intuitive features to track progress, learners can easily monitor their course completion and stay motivated with real-time progress indicators. The platform also encourages community learning by enabling users to chat with friends and knowledge sharing.
            </p>
          </motion.div>
        </div>
      </div>
